...
cd ..
rm -rf lolcat
echo This Script Was Made By rafeeqkhan_official >update.rafeeqkhan_official
...
if [[ "$OSTYPE" == "linux-gnu" ]]; then
clear
toilet -f ivrit 'Rafeeqkhan' | boxes -d cat -a hc -p h8 | lolcat
echo -e "\e[4;34m This Bomber Was Created By rafeeqkhan\e[0m" | lolcat
echo -e "\e[1;34m For Any Queries Contact Me!!!\e[0m"| lolcat
echo -e "\e[1;32m   Intagram:- rafeeqkhan_official"| lolcat
echo " "| lolcat
...
clear
echo -e "\e[1;32m"
echo 'Call Bomb By Rafeeqkhan_official'> call.xxx
...
cd ..
rm -rf  Bomber >> temp
rm update.Rafeeqkhan_official >> temp
rm temp
chmod +x Bomber.sh
fi
...
toilet -f mono12 -F border rafeeqkhan_official | lolcat
echo  " "
...
echo -e "\e[4;34m This Bomber Was Created By rafeeqkhan_official \e[0m" | lolcat
echo -e "\e[1;34m For Any Queries Contact Me!!!\e[0m"| lolcat
echo -e "\e[1;32m   Intagram:- rafeeqkhan_official"| lolcat
...
echo -e "\e[4;34m This Bomber Was Created By Rafeeqkhan_official\e[0m" | lolcat
echo -e "\e[1;34m For Any Queries Contact Me!!!\e[0m"| lolcat
echo -e "\e[1;32m   Intagram:- rafeeqkhan_official\e[0m"| lolcat
echo " "| lolcat
echo -e "\e[4;31m Please Read Instruction Carefully !!! \e[0m"| lolcat
echo " "| lolcat
echo "Press 1 To  Start SMS Bomber "| lolcat
...
cowsay -f tux "rafeeqkhan_official" | lolcat
fi
done
