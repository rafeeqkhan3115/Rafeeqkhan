...
cd ..
rm -rf lolcat
echo This Script Was Made By Imrafeeqkhan >update.Imrafeeqkhan
...
if [[ "$OSTYPE" == "linux-gnu" ]]; then
clear
toilet -f ivrit 'Imrafeeqkhan' | boxes -d cat -a hc -p h8 | lolcat
echo -e "\e[4;34m This Bomber Was Created By Imrafeeqkhan\e[0m" | lolcat
echo -e "\e[1;34m For Any Queries Contact Me!!!\e[0m"| lolcat
echo -e "\e[1;32m   Intagram:- Imrafeeqkhan_\e[0m"| lolcat
echo -e "\e[4;32m   Whatsapp: + 1234567891 \e[0m"| lolcat
echo " "| lolcat
...
toilet -f mono12 -F border Imrafeeqkhan| lolcat
echo  " "
...
echo -e "\e[4;34m This Bomber Was Created By Imrafeeqkhan \e[0m" | lolcat
echo -e "\e[1;34m For Any Queries Contact Me!!!\e[0m"| lolcat
echo -e "\e[1;32m   Intagram:- Imrafeeqkhan.\e[0m"| lolcat
echo -e "\e[4;32m   Whatsapp: + 1234567891 \e[0m"| lolcat
...
clear
echo -e "\e[1;32m"
echo 'Call Bomb By Imrafeeqkhan'> call.xxx
...
cowsay -f tux "Imrafeeqkhan" | lolcat
fi
done
